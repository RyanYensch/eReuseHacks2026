...
export function SuccessScreen({ result }) {
  return (
    ...
    <div className="success-page">
      ...
      <p className="text-lg font-normal text-body lg:text-xl pb-4">
        {result.likelihood}
      </p>
      {/*
      ...
      */}
      ...
      {result.kind === "image" ? (
        <>
          <h2 className="mb-4 mt-6 text-xl font-bold text-heading md:text-3xl lg:text-4xl">
            Your Image
          </h2>
        ...
        <>
          <h2 className="mb-4 mt-4 text-xl font-bold text-heading md:text-3xl lg:text-4xl">
            Your Text
          </h2>
          <p className="text-lg font-normal text-body lg:text-xl pb-4">{result.preview}</p>
        </>
      )}
    </div>
  );
